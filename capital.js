...
const capitalLocationNotabilityTable = [
    ...
    { min: 4, max: 8, name: 'Top-Notch Marketing', description: 'All around the capital you can see signage, or hear people mentioning, the location.' },
...
export {
    ...
    capitalNumberOfDistrictsTable, capitalDistrictNotableLocationsTable, capitalLocationNotabilityTable // <--- ADDED
};
